...
class LoginCheckMiddleWare(MiddlewareMixin):
    ...
    def process_view(self,request,view_func,view_args,view_kwargs):
        ...
        if user.is_authenticated:
            if user.user_type == "1":
                if modulename == "management.HodViews":
                    pass
                ...
                if modulename == "management.StaffViews" or management.EditResultViewClass:
                    pass
                elif modulename == "management.views"  modulename == "django.views.static":
                    pass
                else:
                    return HttpResponseRedirect(reverse("staff_home"))
            elif user.user_type == "3":
                if modulename == "management.StudentViews" or modulename == "django.views.static":
                    pass
                elif modulename == "management.views":
                    pass
                else:
